       ...
       <ul class="space-y-2 font-medium items-center justify-center">
          <li>
            <p  class="flex text-xl p-2 text-gray-900   group">
              <span class="ms-3 ">Categoreis</span>
             </p>
          </li>
          @foreach($viewData['types'] as $type)
          <li>
             <a href="{{ route('product.typemen', $type->id) }}" class="flex items-center ml-3 p-2  text-gray-900  dark:text-white  dark:hover:bg-gray-700 group">
